...
class Register(models.Model):
    ...
    twitter_id = models.TextField(blank=True,default='')
    twitter_token = models.TextField(blank=True,default='')
    twitter_token_secret = models.TextField(blank=True,default='')
    twitter_screen_name = models.TextField(blank=True,default='')
